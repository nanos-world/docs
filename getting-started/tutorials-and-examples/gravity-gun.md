...
{% embed url="https://i.imgur.com/hzZWmNw.mp4" caption="" %}

{% hint style="info" %}
**Tip:** You can now find a fully working Gravity Gun in the [Sandbox](https://github.com/nanos-world/nanos-world-sandbox) game-mode!
{% endhint %}
