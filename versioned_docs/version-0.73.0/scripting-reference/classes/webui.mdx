...
<ReferenceLink href="/docs/getting-started/tutorials-and-examples/basic-hud-html">Basic HUD (HTML)</ReferenceLink>
...
| <BasicType.Boolean /> | **`is_visible`** | `true` |  |
| <BasicType.String /> | **`package_name`** | defaults to this package |  |
...
|  | [**`SetFocus`**](webui#setfocus) | Enables the focus on this browser |
