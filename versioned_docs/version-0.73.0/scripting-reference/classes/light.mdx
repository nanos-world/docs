...
:::info
⏬ **Inheritance:** This class inherits from [Actor](/docs/scripting-reference/classes/base-classes/actor). Please check it's pages for inherited **Methods** and **Events**.
:::
...
| <StructType.Rotator /> | **`rotation`** | `Rotator(0, 0, 0)` | Relevant only for Rect and Spot LightTypes |
| <StructType.Color /> | **`color`** | `Color(1, 1, 1)` |  |
| [LightType](/docs/scripting-reference/glossary/enums#lighttype) | **`light_type`** | `LightType.Point` |  |
...
| :--- | :--- | :--- | :--- |
| <StructType.Color /> | **`color`** |  | The light color |
