...
<ReferenceLink href="/docs/getting-started/tutorials-and-examples/monster-truck">Monster Truck</ReferenceLink>

:::info
⏬ **Inheritance:** This class inherits from [Actor](/docs/scripting-reference/classes/base-classes/actor) and [Paintable](/docs/scripting-reference/classes/base-classes/paintable). Please check their pages for inherited **Methods** and **Events**.
:::
...
| :--- | :--- | :--- | :--- |
|  |  | [**`AddStaticMeshAttached`**](vehicle#addstaticmeshattached) | Spawns and Attaches a StaticMesh into this Vehicle in a Socket with relative Location and Rotation |
...
|  | [Character](/docs/scripting-reference/classes/character) | [**`GetPassenger`**](vehicle#GetPassenger) | Gets a passengers at an index |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| [DifferentialType](/docs/scripting-reference/glossary/enums#differentialtype) | **`differential_type`** | `LimitedSlip_4W` | |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| <BasicType.Boolean /> | **`has_automatic_transmission`** | `true` |  |
| <BasicType.Number /> |
| <BasicType.Number /> |
...
| <BasicType.Number /> |
| <BasicType.Number />. A handbrake should have a stronger brake torque than the brake. This will be ignored for wheels that are not affected by the handbrake |
| <BasicType.Boolean /> | **`is_affected_by_handbrake`** | `true` |  |
| <StructType.Vector /> | **`offset`** | `Vector(0, 0, 0)` | If **bone\_name** is specified, offset the wheel from the bone’s location. Otherwise this offsets the wheel from the vehicle’s origin |
...
| <StructType.Vector /> | **`offset_location`** |  |  |
| <StructType.Vector /> | **`seat_location`** |  |  |
| <StructType.Rotator /> | **`seat_rotation`** |  |  |
...
| :--- | :--- | :--- | :--- |
| <StructType.Vector /> | **`location`** |  |  |
| <StructType.Color /> | **`color`** | `Color(1, 0.86, 0.5)` |  |
...
>
> returns [Player ](/docs/scripting-reference/classes/player)or [nil ](/docs/scripting-reference/glossary/basic-types#nil)if Seat is invalid or empty
