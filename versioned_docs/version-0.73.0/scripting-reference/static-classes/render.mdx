...
:::caution
If you are looking for how to make UIs, we recommend taking a look at [WebUI](/docs/scripting-reference/classes/webui) for a more robust and optimal system.
:::

<ReferenceLink href="/docs/core-concepts/scripting/user-interface">User Interface</ReferenceLink>
...
| <StructType.Vector2D /> | [**`Project`**](render#project) | Transforms a 3D world-space vector into 2D screen coordinates. |
...
| <StructType.Vector2D /> | [**`GetViewportSize`**](render#getviewportsize) | Returns the size of viewport \(how much screen space the game window occupies\) |
...
| <StructType.Vector2D /> | **`start_position`** | Screen position |
| <StructType.Vector2D /> | **`end_position`** | Screen position |
| <BasicType.Number /> | **`thickness`** | Line thickness |
| <StructType.Color /> | **`color`** | Line color |
...
| <StructType.Color /> | **`color`** | Box color |
...
| :--- | :--- | :--- |
| <BasicType.Number /> | **`group_id`** | The group ID to associate this item |
| <StructType.Vector2D /> | **`position`** | Screen position |
| <StructType.Vector2D /> | **`size`** | Tile size |
| <StructType.Color /> | **`color`** | Box color |
...
| <BasicType.Number /> | **`group_id`** | The group ID to associate this item |
| <StructType.Vector2D /> | **`start_position`** | Screen position |
| <StructType.Vector2D /> | **`radius`** | Polygon radius |
...
| <StructType.Vector2D /> | **`position`** | Screen position |
| [FontType](/docs/scripting-reference/glossary/enums#fonttype) | **`font_type`** |  |
| <BasicType.Number /> | **`font_size`** |  |
| <StructType.Color /> | **`text_color`** |  |
| <BasicType.Number /> | **`kerning`** |  |
| <BasicType.Boolean /> | **`is_centered_x`** |  |
| <BasicType.Boolean /> | **`is_centered_y`** |  |
| <BasicType.Boolean /> | **`enable_shadow`** |  |
| <StructType.Vector2D /> | **`shadow_offset`** |  |
| <StructType.Color /> | **`shadow_color`** |  |
| <BasicType.Boolean /> | **`enable_outline`** |  |
| <StructType.Color /> | **`shadow_outline_color`** |  |
...
| Type | Parameter | Description |
| :--- | :--- | :--- |
| <StructType.Vector /> | **`world_position`** | World 3D position |
...
| Type | Parameter | Description |
| :--- | :--- | :--- |
| <StructType.Vector2D /> | **`screen_position`** | Screen position |
...
| <BasicType.Number /> | **`group_id`** | The group ID to associate this item |
| <BasicType.Number /> | **`item_id`** | The item of the Text |
| <StructType.Vector2D /> | **`new_position`** | Screen position |
...
| Type | Parameter | Description |
| :--- | :--- | :--- |
| <StructType.Vector2D /> | **`new_size`** | New new screen size |
