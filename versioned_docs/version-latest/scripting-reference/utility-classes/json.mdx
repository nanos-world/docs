...
| :--- | :--- | :--- |
| <BasicType.String /> | Returns a string representing value encoded in JSON |
| <BasicType.Any /> | **`parse`**\(<BasicType.String /> | Returns a value representing the decoded JSON string |
