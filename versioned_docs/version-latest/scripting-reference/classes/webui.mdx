...
#### Using a WebUI as Mesh Material {/* #using-a-webui-as-mesh-material */}

```lua title="Client/Index.lua" showLineNumbers
-- Spawns a WebUI hidden from the screen, not transparent, not auto resized and with size of 500x500
local my_ui = WebUI("Awesome Site", "https://nanos-world.com", WidgetVisibility.Hidden, false, false, 500, 500)
...
#### Communicating between Lua and JS (WebUI) {/* #communicating-between-lua-and-js-webui */}
...
#### Pretty Scroll Bar {/* #pretty-scroll-bar */}
...
You can also use a Canvas as a mesh material, with the [:SetMaterialFromCanvas()](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialfromcanvas) method!
...
## 🔍 HTML Path Searchers {/* #html-path-searchers */}
