...
| <Structs.Vector /> | **`offset`** | `Vector(0, 0, 0)` | If **bone\_name** is specified, offset the wheel from the bone’s location. Otherwise this offsets the wheel from the vehicle’s origin |
