...
More parameters and complete information can be found at the [PostgreSQL Official Documentation](https://www.postgresql.org/docs/current/libpq-connect.html).
