...
You can use the output Texture from a SceneCapture with [:SetMaterialFromSceneCapture()](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialfromscenecapture) method!
