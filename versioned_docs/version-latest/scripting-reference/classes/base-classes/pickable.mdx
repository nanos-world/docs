...
## ➕ Available Crosshairs {/* #-available-crosshairs */}
...
#### List of crosshair materials included in the default asset pack {/* #list-of-crosshair-materials-included-in-the-default-asset-pack */}
