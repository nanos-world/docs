...
import { Structs, BasicType, AuthorityType, Enums, AssetPath, Classes } from '@site/docs/components/_nanos.mdx';
...
| <AssetPath.Sound /> | **`asset`** | ` ` | The Sound Asset or Special Path |
...
| <BasicType.Boolean /> | [**`Is2D`**](sound#is2d) | Returns if the sound is 2D |
...
| <BasicType.Number /> | [**`GetPitch`**](sound#getpitch) | Returns the pitch |
| <BasicType.Number /> | [**`GetVolume`**](sound#getvolume) | Returns the volume |
| <BasicType.Number /> | [**`GetLowPassFilter`**](sound#getlowpassfilter) | Returns the Low Pass Filter Frequency |
| <BasicType.Number /> | [**`GetInnerRadius`**](sound#getinnerradius) | Returns the Attenuation Inner Radius |
| <BasicType.Number /> | [**`GetFalloffDistance`**](sound#getfalloffdistance) | Returns the Attenuation Falloff Distance |
| <Enums>SoundType</Enums> | [**`GetSoundType`**](sound#getsoundtype) | Returns the Sound Type |
