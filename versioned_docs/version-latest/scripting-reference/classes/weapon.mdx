---
title: 🔫 Weapon
description: A Weapon represents an Entity which can be Pickable by a Character and can be used to shoot, with fully customizable ammo, sounds, animations and particles.
sidebar_position: 0
tags: [class]
---
...
Using the [default-weapons](https://nanos-world.com/store/packages/default-weapons) Package to spawn an AK47. First add it to the `packages_requirements` of your `Package.toml`:
