...
## Available [Crosshairs Types](./scripting-reference/glossary/enums.md#crosshairtype)

![All available Crosshairs](/img/docs/crosshairs_dark.jpg)
...
| <AuthorityType.ServerOnly /> |  | [**`SetSpread`**](weapon#setspread) | Base Weapon’s Spread \(the higher the less precision - recommended value: 20\) |
