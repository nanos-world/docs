...
import ClassData from '@site/src/api/Classes/Weapon.json';


<HeaderDeclaration class_data={ClassData} image="/img/docs/weapon.webp" />
...
This Package is already included in the base game, you just need to `Package.Require("nanos-world-weapons")` and use it!
