...
| <AssetPath.StaticMesh /> | **`asset`** | ` ` | Static Mesh Asset to use |
| <Enums>CollisionType</Enums> | **`collision_type`** | `CollisionType.Auto` | Collision |
...
| <AuthorityType.AuthorityOnly /> |  | [**`SetPhysicsDamping`**](prop#setphysicsdamping) | Sets the Physics damping of this Prop |
| <AuthorityType.Both /> | <BasicType.String /> | [**`GetAssetName`**](prop#getassetname) | Gets the Asset name |
| <AuthorityType.Both /> | <Classes.Character /> | [**`GetHandler`**](prop#gethandler) | Gets the Character \(if existing\) which is holding this |
| <AuthorityType.Both /> | <BasicType.Boolean /> | [**`IsGrabbable`**](prop#isgrabbable) | Gets ability to Grab this Prop |
...
### <AuthorityType.AuthorityOnly />`SetPhysicsDamping`
...
### <AuthorityType.Both />`IsGrabbable`
