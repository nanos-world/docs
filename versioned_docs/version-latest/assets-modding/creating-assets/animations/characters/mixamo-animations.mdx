...
Now you just need to import it into your Unreal Engine Project! We are going to import it into our ADK to create a new Asset Pack with the animations we imported!
...
Select **Platforms ➡ Cook Content ➡ Cook Content**, it will start cooking your assets. See [Exporting & Cooking your Assets](/assets-modding/creating-assets/importing-assets.mdx#exporting--cooking-your-assets) for more details (the screenshots below show the older Unreal Engine 4 flow).
