...
Weapons use [Skeletal Meshes](https://dev.epicgames.com/documentation/en-us/unreal-engine/skeletal-mesh-assets-in-unreal-engine). The Skeletal Mesh must point towards the Red Axis (X) to be properly rotated.
...
### Fixing Offsets, Scale & Rotation {/* #fixing-offsets-scale--rotation */}
...
## Custom Bone Sockets {/* #custom-bone-sockets */}
...
The **muzzle** Socket is where the [Particle Barrel](/scripting-reference/classes/weapon.mdx#function-setparticlesbarrel) will be attached. So create a socket and place it in the muzzle of the weapon:
...
### `shell_eject` {/* #shell_eject */}

The **shell_eject** Socket is where the [Particle Shells](/scripting-reference/classes/weapon.mdx#function-setparticlesshells) will be attached. So create a socket and place it in shells eject of the weapon:
...
## Exporting the Weapon {/* #exporting-the-weapon */}
