...
Before proceeding, please make sure you followed the first steps and installed [Unreal Engine](setting-up-ue.mdx) and downloaded the [Assets Development Kit](adk-assets-development-kit.mdx) project.
...
## Game or Plugin Content {/* #game-or-plugin-content */}
...
### Option A: Using Game Content {/* #option-a-using-game-content */}
...
### Option B: Using Plugin Content {/* #option-b-using-plugin-content */}
...
And in the upper left corner, click `+ Add`:
...
## Importing external Assets {/* #importing-external-assets */}
...
## Exporting & Cooking your Assets {/* #exporting--cooking-your-assets */}
...
## Creating your Asset Pack {/* #creating-your-asset-pack */}
...
#### Copy the Cooked Assets {/* #copy-the-cooked-assets */}
...
#### Create the Assets.toml file {/* #create-the-assetstoml-file */}
...
## Configuring your Assets.toml {/* #configuring-your-assetstoml */}
...
You can use the [ADK Assets.toml Generator Tool](adk-assets-development-kit.mdx#assetstoml-generator) to generate your Assets.toml automatically!
...
### Cook only what is needed {/* #cook-only-what-is-needed */}
...
### Name your assets properly {/* #name-your-assets-properly */}

We highly recommend and encourage you to follow [Allar's Asset Naming Conventions](https://github.com/Allar/ue5-style-guide#1-asset-naming-conventions-) as a pattern for naming your assets and organizing your project folder.
...
### Reduce the size of your Assets {/* #reduce-the-size-of-your-assets */}
...
### Creating Assets Thumbnails {/* #creating-assets-thumbnails */}
...
You can use the [ADK Thumbnail Generator Tool](adk-assets-development-kit.mdx#thumbnail-generator) to generate them!


### Using Engine Content {/* #using-engine-content */}
...
#### 1. Make sure you are not copying Project Assets instead of Cooked Assets {/* #1-make-sure-you-are-not-copying-project-assets-instead-of-cooked-assets */}

> Unreal Project files are not meant to work in runtime, they must be compiled/cooked to load in-game. The cooked assets usually have the extensions: `.uasset`, `.uexp` and `.ubulk`. [See more here](#exporting--cooking-your-assets).

#### 2. Make sure your [ADK is updated](adk-assets-development-kit.mdx#updating-to-a-newer-adk-version) {/* #2-make-sure-your-adk-is-updated */}

> Cooking your assets with old ADK can cause incompatibilities between the Game and your Assets.

#### 3. Delete `Saved/`, `Intermediate/` and `DerivedDataCache/` from your Project folder {/* #3-delete-saved-intermediate-and-deriveddatacache-from-your-project-folder */}

> Sometimes it's good to try a full recook, as the Cooked assets can get corrupted by old Unreal versions.

#### 4. Copy all used cooked assets folder into your Asset Pack {/* #4-copy-all-used-cooked-assets-folder-into-your-asset-pack */}
...
#### 5. If you use Git, make sure LFS was enabled {/* #5-if-you-use-git-make-sure-lfs-was-enabled */}
...
#### 6. Verify your Unreal Engine Installation {/* #6-verify-your-unreal-engine-installation */}
...
#### Assets without Materials/Textures {/* #assets-without-materialstextures */}
...
#### Corrupt data found, please verify your installation {/* #corrupt-data-found-please-verify-your-installation */}
...
#### Game Crash during/after loading a custom map or custom assets {/* #game-crash-duringafter-loading-a-custom-map-or-custom-assets */}
...
#### Disconnected. Failed to Load Map! Canceled or Failed! {/* #disconnected-failed-to-load-map-canceled-or-failed */}
