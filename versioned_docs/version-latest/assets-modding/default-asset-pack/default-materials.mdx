...
For more information regarding **Material Types** and **Blend Modes**, please refer to [Unreal Docs](https://dev.epicgames.com/documentation/en-us/unreal-engine/material-blend-modes-in-unreal-engine).

:::


#### Parameters Supported by Default Materials {/* #parameters-supported-by-default-materials */}

| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| [Color](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialcolorparameter) | **`Tint`** | `Color.WHITE` | Affects `Base Color` input. **Tint** multiplies with **Texture** parameter to generate the final color |
| [Texture](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialtextureparameter) | **`Texture`** | White Texture | Image which multiplies with **Tint** to generate the final color |
| [Texture](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialtextureparameter) | **`Normal`** | UP Normal Map `Vector(0.5, 0.5, 1)` | Image which affects how Light reflects on the object |
| [​​​Color​](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialcolorparameter) | **`Emissive`** | `Color.BLACK` | Affects `Emissive` input, high values will cause bloom effect |
| [Scalar​](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialscalarparameter) | **`Metallic`** | `0` | Affects `Metallic` input - goes from 0 to 1 |
| [Scalar](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialscalarparameter) | **`Specular`** | `0.5` | Affects `Specular` input - goes from 0 to 1 |
| [Scalar](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialscalarparameter) | **`Roughness`** | `0.65` | Affects `Roughness` input - goes from 0 to 1 |
| [Scalar](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialscalarparameter) | **`Opacity`** | `0` | Affects `Opacity` and `Opacity Mask` inputs - goes from 0 to 1 <br />**Opacity** multiplies with **Texture** Alpha Channel to generate the final opacity |

:::tip

For more information regarding how each Parameter affects the final visual, please take a look at Unreal [Physically Based Materials](https://dev.epicgames.com/documentation/en-us/unreal-engine/physically-based-materials-in-unreal-engine) and [Material Inputs](https://dev.epicgames.com/documentation/en-us/unreal-engine/material-inputs-in-unreal-engine) docs page.

:::


### **`M_Default_Masked_Lit`** {/* #m_default_masked_lit */}

**Masked** and **Lit** Material.


### **`M_Default_Masked_Lit_WorldAligned`** {/* #m_default_masked_lit_worldaligned */}

**Masked** and **Lit** Material, with `WorldAlignedTexture` node, scaled with `TextureSize` scalar parameter.


### **`M_Default_Masked_Unlit`** {/* #m_default_masked_unlit */}

**Masked** and **Unlit** Material.


### **`M_Default_Translucent_Lit`** {/* #m_default_translucent_lit */}

**Translucent** and **Lit** Material.


### **`M_Default_Translucent_Lit_Depth`** {/* #m_default_translucent_lit_depth */}
...
### **`M_Default_Translucent_Lit_Decal`** {/* #m_default_translucent_lit_decal */}

**Translucent**, **Lit** with `Deferred Decal` Material Domain, to be used in <Classes.Decal />.


### **`M_Default_Translucent_Unlit`** {/* #m_default_translucent_unlit */}

**Translucent** and **Unlit** Material.


### **`M_Default_Translucent_Unlit_Depth`** {/* #m_default_translucent_unlit_depth */}
...
## Special Utils Materials {/* #special-utils-materials */}
...
**Note**: All those Materials in this page are already included in the base game in the [Default nanos world Asset Pack](/assets-modding/default-asset-pack/default-assets-list.mdx), you can reference them like that: **`nanos-world::M_Default_Masked_Lit`**.
...
#### Supported Common Parameters in each Material {/* #supported-common-parameters-in-each-material */}
...
[Physical Materials](https://dev.epicgames.com/documentation/en-us/unreal-engine/physical-materials-in-unreal-engine) are materials which define Physical properties of an object. With [Paintable.SetPhysicalMaterial()](/scripting-reference/classes/base-classes/paintable.mdx#function-setphysicalmaterial) you can change the default physical material of an Entity.
