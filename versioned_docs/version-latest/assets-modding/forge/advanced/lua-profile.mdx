---
title: Lua Profile
description: Configure how Forge formats the Lua code it generates
tags: [assets, forge]
...
## Creating Lua Profiles {/* #creating-lua-profiles */}
...
### Lua Struct Format Profile {/* #lua-struct-format-profile */}
...
#### Example Struct Profile (Vector as Constructor) {/* #example-struct-profile-vector-as-constructor */}
...
#### Example Struct Profile (Transform as Table) {/* #example-struct-profile-transform-as-table */}
...
### Lua Object Format Profile {/* #lua-object-format-profile */}
...
#### Example Object Profile (Prop Placeholder) {/* #example-object-profile-prop-placeholder */}
...
## Built-in Struct Profiles {/* #built-in-struct-profiles */}
...
## Lua Global Profile {/* #lua-global-profile */}
...
## Using Profiles in Tools {/* #using-profiles-in-tools */}
