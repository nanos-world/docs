---
title: Object2Lua
description: Forge tool that converts Unreal Engine blueprint assets into Lua tables
tags: [assets, forge]
...
| Setting | Description |
| :--- | :--- |
| **`Global Profile`** | The formatting profile to use. See [Lua Profile](/assets-modding/forge/advanced/lua-profile.mdx) |
...
### Creating a Primary Data Asset {/* #creating-a-primary-data-asset */}
...
### Creating a Data Asset {/* #creating-a-data-asset */}
...
### Example Data Asset Output {/* #example-data-asset-output */}
