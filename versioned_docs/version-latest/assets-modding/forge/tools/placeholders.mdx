...
Unlike the placeholders in the [ADK](/docs/assets-modding/creating-assets/adk-assets-development-kit.mdx), Forge placeholders are not limited to hardcoded classes. You can create your own placeholder actors with custom properties and export them to Lua code.
