...
The installation on versions on and below Debian 13, Ubuntu 22 and ARM systems is not officially supported and currently maintained by the community! The following steps are WIP and may change at any time!
...
If you are running debian 12 or older, please upgrade to debian 13 or change your operating system to at least Ubuntu 22.04.1 LTS
