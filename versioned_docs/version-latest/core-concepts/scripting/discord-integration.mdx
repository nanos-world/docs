...
## Updating the Player Discord Activity (Rich Presence) {/* #updating-the-player-discord-activity-rich-presence */}
...
## Using your own Application ID {/* #using-your-own-application-id */}
...
And you are done! Now you can use the <MethodReference type="StaticClass" class_name="Discord" method_name="SetActivity" show_class_name /> method!
