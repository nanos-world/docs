...
## Adding Entries to an Entity/Tool Gun {/* #adding-entries-to-an-entitytool-gun */}
...
### When selecting an Entity {/* #when-selecting-an-entity */}
...
### When picking up an Entity {/* #when-picking-up-an-entity */}
...
Also, you can see a working example of dynamically adding an entry to the Context Menu in the [BalloonGun](https://github.com/nanos-world/nanos-world-sandbox/blob/master/Client/Tools/BalloonGun.lua).