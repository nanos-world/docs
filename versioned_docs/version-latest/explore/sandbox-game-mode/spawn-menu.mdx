...
```lua title=your-package/Client/Index.lua
...
```lua title=your-package/Server/Index.lua
...
All Classes inherited from <Classes.Vehicle /> will appear in the vehicles tab by default.
