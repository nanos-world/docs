...
<CardLink
	...
	description="Official Vehicles Pack, available in the Vault as default-vehicles"
	image_src="/img/docs/vehicles-pack.webp"
	href="https://github.com/nanos-world/default-vehicles"
/>

<CardLink
	title="Default Weapons"
	description="Official Weapons Pack, available in the Vault as default-weapons"
	image_src="/img/docs/weapons-pack.webp"
	href="https://github.com/nanos-world/default-weapons"
/>
...
## Awesome Community Resources {/* #awesome-community-resources */}
...
#### Packages & Libraries {/* #packages--libraries-1 */}

<div className="card-links">

<CardLink
	title="Echo Lib"
	description="A complete utility library for Nanos World with ready-to-use systems (menus, dialogs, notifications, commands, etc.), developed by YOLTIX and designed by Shavkat."
	image_src="https://imgg.fr/r/eEnkX5nT.jpg"
	href="https://nanos-world.com/store/packages/echolib"
/>
