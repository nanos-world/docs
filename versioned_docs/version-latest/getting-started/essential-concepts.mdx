...
import { Classes, StaticClasses, AssetPath, AuthorityType } from '@site/docs/components/_nanos.mdx';
...
For more information refer to our Widget tutorial:

<ReferenceLink href="getting-started/tutorials-and-examples/basic-hud-widget">Basic HUD (Widget)</ReferenceLink>
