...
## Setting Up a Google Cloud Server from Scratch for nanos world {/* #setting-up-a-google-cloud-server-from-scratch-for-nanos-world */}
...
### Step 1: Sign In to Google Cloud {/* #step-1-sign-in-to-google-cloud */}
...
### Step 2: Create a New Google Cloud Server {/* #step-2-create-a-new-google-cloud-server */}
...
### Step 3: Use your Google Cloud Server {/* #step-3-use-your-google-cloud-server */}
...
### Step 4: Installing nanos world server {/* #step-4-installing-nanos-world-server */}
...
### Step 5: Forwarding Ports in the Google Cloud {/* #step-5-forwarding-ports-in-the-google-cloud */}
