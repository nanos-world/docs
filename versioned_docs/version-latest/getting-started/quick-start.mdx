...
By default the server runs as **Playtest**. If you are playing the full game (not the Playtest), start the server with `--steam_app "game"`, otherwise you will not be able to connect to it.
