...
This sample aims to show how it is possible to create a Gravity Gun to move objects around in nanos world. Pretty much like in Garry's Mod.


.. raw:: html

	<video controls src="https://i.imgur.com/hzZWmNw.mp4" width="100%"></video><br><br>
...
.. tabs::
 .. code-tab:: lua Server
    ...
    local p_sphere = Prop(Vector(200, 0, 200), Rotator(), "NanosWorld::SM_Sphere")
    local p_cone = Prop(Vector(200, 0, 200), Rotator(), "NanosWorld::SM_Cone")
    local sm_cube = StaticMesh(Vector(100, 0, 200), Rotator(), "NanosWorld::SM_Cube")
    local sm_cylinder = StaticMesh(Vector(300, 0, 200), Rotator(), "NanosWorld::SM_Cylinder")
...
.. tabs::
 .. code-tab:: lua Client
    ...
    Client:SetHighlightColor(Color(0, 20, 20, 1.5), 1)
