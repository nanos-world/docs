...
#### Please WISHLIST NOW!!! {/* #please-wishlist-now */}
...
## New Class: [Blueprint](/docs/next/scripting-reference/classes/blueprint) {/* #new-class-blueprint */}
...
## New Class: [Database](/docs/next/scripting-reference/classes/database) {/* #new-class-database */}
...
## Vehicles Tire Skid Mark {/* #vehicles-tire-skid-mark */}
...
## Sandbox Improvements {/* #sandbox-improvements */}
...
## New [Particle Methods](/docs/next/scripting-reference/classes/particle) {/* #new-particle-methods */}
...
### Music Concurrency {/* #music-concurrency */}
...
### Client-side [Props](/docs/next/scripting-reference/classes/prop) {/* #client-side-props */}
...
### Level Static Meshes {/* #level-static-meshes */}

![](/img/blog/2022-march/been.jpg)

Now all [StaticMeshActors](https://docs.unrealengine.com/4.27/en-US/Basics/Actors/StaticMeshActor/) from a Map are automatically loaded as [StaticMesh](/docs/next/scripting-reference/classes/staticmesh) entity on Client Side! It is possible to paint, destroy, move and everything else on them on client-side!


### Async Texture Loading {/* #async-texture-loading */}
...
### Async [File](/docs/next/scripting-reference/classes/file) Loading {/* #async-file-loading */}

In addition to the above, we've expanded our Async implementation into File class, which now have the `:ReadAsync()` method!


### New [Light](/docs/next/scripting-reference/classes/light) Methods {/* #new-light-methods */}

We've added a bunch of missing Light setters and getters methods, also the ability to toggle it on/off with `SetVisibility()`.


### [Assets.toml](/docs/next/core-concepts/assets#assets-pack-configuration) Changes {/* #assetstoml-changes */}
...
### Sun Improvements {/* #sun-improvements */}
