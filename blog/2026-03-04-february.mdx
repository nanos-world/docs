...
## April Fools Bonanza Playtest {/* #april-fools-bonanza-playtest */}
...
## Zenkai: New Ninja RP Server {/* #zenkai-new-ninja-rp-server */}
...
## New Feedback & Bugs Hub {/* #new-feedback--bugs-hub */}

We are migrating from GitHub Issues & Canny to this new [Feedback & Bugs Hub](https://feedback.nanos-world.com/) tool!

It will be used to handle both **bugs** and **feedback** ideas! Since Canny changed their pricing plans and we were kicked out, we found this new tool suitable for our needs, and also we decided to centralize the Bug Reports on it too!

As always, if you have suggestions or found bugs, please report them to us there! 😅


## Asset Packs Multiple Folders {/* #asset-packs-multiple-folders */}
...
## VSCode Official Extension {/* #vscode-official-extension */}
...
### New Class: InstancedStaticMesh {/* #new-class-instancedstaticmesh */}
...
- Added a new method <MethodReference type="StaticClass" class_name="Viewport" method_name="SetBrandingBarSettings" show_class_name /> for customizing the "nanos world" bar on screen, now it's possible to set it's position and show less information.
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPLocalMaxDistance" show_class_name />
- <MethodReference type="StaticClass" class_name="Package" method_name="IsUnloading" show_class_name />


#### Improved Methods {/* #improved-methods */}

- Added a new parameter to <MethodReference type="Class" class_name="Pawn" method_name="StopMovement" show_class_name />: `stop_velocity`, to also stop it's velocity.
- Moved <MethodReference type="Class" class_name="Entity" method_name="IsBeingDestroyed" />, <MethodReference type="Class" class_name="Entity" method_name="HasAuthority" /> from <Classes.Actor /> to <Classes.Entity />.
- Moved <MethodReference type="Class" class_name="Damageable" method_name="GetDamageMultiplier" /> and <MethodReference type="Class" class_name="Damageable" method_name="SetDamageMultiplier" /> from <Classes.Character /> to <Classes.Damageable />.


#### Persistent Data keys separated by . {/* #persistent-data-keys-separated-by- */}

Now <MethodReference type="StaticClass" class_name="Package" method_name="SetPersistentData" show_class_name /> supports passing keys separated by `.`.
...
- Added new methods to <Structs.Quat />: <MethodReference type="Struct" class_name="Quat" method_name="UnrotateVector" />, <MethodReference type="Struct" class_name="Quat" method_name="RotateVector" />, <MethodReference type="Struct" class_name="Quat" method_name="GetForwardVector" />, <MethodReference type="Struct" class_name="Quat" method_name="GetRightVector" /> and <MethodReference type="Struct" class_name="Quat" method_name="GetUpVector" />.
- Added new methods to <Structs.Vector />: <MethodReference type="Struct" class_name="Vector" method_name="ToOrientationQuat" /> and <MethodReference type="Struct" class_name="Vector" method_name="ToOrientationRotator" /> (renamed from `Rotator()`).


#### Rotator Rotate/UnrotateVector() Breaking Change {/* #rotator-rotateunrotatevector-breaking-change */}

We had figured out an issue with our <MethodReference type="Struct" class_name="Rotator" method_name="RotateVector" show_class_name />/<MethodReference type="Struct" class_name="Rotator" method_name="UnrotateVector" show_class_name /> methods, where they were inverted.
...
#### New Scripting Guards {/* #new-scripting-guards */}
...
Use <MethodReference type="StaticClass" class_name="Package" method_name="IsUnloading" show_class_name /> inside <EventReference type="Class" class_name="Entity" event="Destroy" /> events to prevent the errors.


## Profiling & Debug {/* #profiling--debug */}
...
## Forge Plugin with the ADK {/* #forge-plugin-with-the-adk */}
...
### Constructor Cache System {/* #constructor-cache-system */}
...
## More Sandbox Updates {/* #more-sandbox-updates */}
...
## Steam Page Translation {/* #steam-page-translation */}
