...
## Introducing... Go Horse Studios! {/* #introducing-go-horse-studios */}
...
## Halloween Playtest Recap {/* #halloween-playtest-recap */}
...
### Screenshot Highlights {/* #screenshot-highlights */}
...
## Unreal Engine 5.7 {/* #unreal-engine-57 */}
...
### New Video Settings {/* #new-video-settings */}
...
## File Validator Rework {/* #file-validator-rework */}
...
## Unified Package Cache {/* #unified-package-cache */}
...
## File Transfer Rework {/* #file-transfer-rework */}
...
It is now possible to programmatically show notifications to players via the integrated system while they are playing: <MethodReference type="StaticClass" class_name="Client" method_name="ShowNotification" show_class_name />.

It will also display **FATAL** and **ERROR** logs that may occur during gameplay.


## Debug Improvements {/* #debug-improvements */}

### Profiling Stack {/* #profiling-stack */}
...
### Profiling Entities Network {/* #profiling-entities-network */}
...
### VOIP/Fire Events {/* #voipfire-events */}
...
### New `max_send_rate` Setting {/* #new-max_send_rate-setting */}
...
### Suggest/Report Button {/* #suggestreport-button */}
...
### Steam SDK update {/* #steam-sdk-update */}
