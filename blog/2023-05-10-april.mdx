...
## Vehicle Damage System {/* #vehicle-damage-system */}
...
This behavior can be configured with the new method: [`Vehicle.SetExplosionSettings()`](/docs/next/scripting-reference/classes/vehiclewheeled#function-setexplosionsettings).
...
## Vehicle Flatten Tires {/* #vehicle-flatten-tires */}
...
Also it can be manually scripted with a new method [`Vehicle.SetTireFlat(index, true)`](/docs/next/scripting-reference/classes/vehiclewheeled#function-settireflat).
...
### Standard Lua Classes {/* #standard-lua-classes */}
...
### Functions Hint Format {/* #functions-hint-format */}
...
### Tables Hint Format {/* #tables-hint-format */}
...
## Server Lean Assets {/* #server-lean-assets */}
...
## Utility & Native Tables {/* #utility--native-tables */}
...
## Improved Escape Menu {/* #improved-escape-menu */}
...
## Blueprints Parameters {/* #blueprints-parameters */}
...
## New Debug Settings {/* #new-debug-settings */}
...
## New Cache System {/* #new-cache-system */}
...
## File Client Side {/* #file-client-side */}
...
### Loading Screen Time {/* #loading-screen-time */}
...
### Canvas Screen Position {/* #canvas-screen-position */}
