...
### AI Avoidance Method {/* #ai-avoidance-method */}
...
We had this enabled by default, but we exposed a way to disable it on demand, with a new method <MethodReference type="Class" class_name="Pawn" method_name="SetAIAvoidanceSettings" show_class_name /> to allow customizing this behavior.


### Escape Key Override {/* #escape-key-override */}
...
## DLSS 4 Full Integration {/* #dlss-4-full-integration */}
...
### Reflex Low Latency {/* #reflex-low-latency */}
...
### Console Freeze Fix {/* #console-freeze-fix */}
...
### Testing Map NavMesh {/* #testing-map-navmesh */}
...
#### That Static Boat {/* #that-static-boat */}
...
### Testing Map Shadows {/* #testing-map-shadows */}
...
## Testing Map Improvs. {/* #testing-map-improvs */}

Other Testing Map improvements made:

### Torches On/Off {/* #torches-onoff */}
...
## Minor Honorable Mentions {/* #minor-honorable-mentions */}

Some small improvements made:


### Main Menu FPS {/* #main-menu-fps */}

The Main Menu is now capped to your monitor's refresh rate (was previously capped at 120).


### Unreal Updated 5.4.4 {/* #unreal-updated-544 */}
