...
## New Sizzle Reel Video! {/* #new-sizzle-reel-video */}
...
## New Registration Forms! {/* #new-registration-forms */}
...
### Helper & Moderator {/* #helper--moderator */}
...
## Account Discord Linking {/* #account-discord-linking */}
...
## FSR Integration & Upscaling {/* #fsr-integration--upscaling */}
...
## New Events Format {/* #new-events-format */}
...
### Reliability Argument {/* #reliability-argument */}
...
### Send In Radius {/* #send-in-radius */}

Another addition is the new methods for broadcasting remote events to players in a specific `radius` around a `location`.

- <MethodReference type="StaticClass" class_name="Events" method_name="BroadcastRemoteInRadius" show_class_name />
- <MethodReference type="StaticClass" class_name="Events" method_name="BroadcastRemoteInRadiusDimension" show_class_name />
- <MethodReference type="Class" class_name="Entity" method_name="BroadcastRemoteInRadiusEvent" show_class_name />
...
### Query In Radius {/* #query-in-radius */}
...
- <MethodReference type="StaticClass" class_name="Server" method_name="GetPlayersInRadius" show_class_name />
- <MethodReference type="StaticClass" class_name="Server" method_name="GetActorsInRadius" show_class_name />
- <MethodReference type="StaticClass" class_name="Client" method_name="GetActorsInRadius" show_class_name />
...
- <MethodReference type="Class" class_name="CharacterSimple" method_name="SetAnimationBlueprintPropertyValue" show_class_name />
- <MethodReference type="Class" class_name="Entity" method_name="CallRemotePlayersEvent" show_class_name />


### Increased Dimensions Limit {/* #increased-dimensions-limit */}
...
### New Hide All Keybinding {/* #new-hide-all-keybinding */}
...
### Profile Account Tab {/* #profile-account-tab */}
...
#### Video Settings Layout {/* #video-settings-layout */}
...
#### House Keeping Reworked {/* #house-keeping-reworked */}
...
#### In-game Microphone Test {/* #in-game-microphone-test */}
...
#### New `clear` Server Console Command {/* #new-clear-server-console-command */}

We added a new `clear` console command that allows you to clear the console output.


#### Automatically Clean CEF Cache {/* #automatically-clean-cef-cache */}
...
#### Compatibility Version Warnings {/* #compatibility-version-warnings */}
