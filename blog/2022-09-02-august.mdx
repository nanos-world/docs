...
[![](/img/blog/2022-august/vscode.webp)](https://marketplace.visualstudio.com/items?itemName=go-horse-studios.nanos-world)

With the API, it was possible to professionalize the extension of [nanos world for VSCode](https://marketplace.visualstudio.com/items?itemName=go-horse-studios.nanos-world), created by **@Derpius**. Now it uses the API to generate all the Lua stubs!
...
## Smart Documentation {/* #smart-documentation */}
...
## New UI (Console & Chat) {/* #new-ui-console--chat */}
...
## New Profiling Stats {/* #new-profiling-stats */}
...
## Trigger Whitelist {/* #trigger-whitelist */}
...
## SceneCapture Render Only {/* #scenecapture-render-only */}
...
## Melee Improvements {/* #melee-improvements */}
...
## Native LoadPackage {/* #native-loadpackage */}
...
## CEF Improvements {/* #cef-improvements */}
...
## Auth Website Redesign {/* #auth-website-redesign */}
...
## Tons of Bug Fixes {/* #tons-of-bug-fixes */}
...
<YouTubeEmbed>VeStKCAokgg</YouTubeEmbed>

<YouTubeEmbed>Y-3T6qZfXgo</YouTubeEmbed>
