...
This behavior can be configured with the new method: [`Vehicle.SetExplosionSettings()`](/docs/scripting-reference/classes/vehicle#function-setexplosionsettings).
...
Also it can be manually scripted with a new method [`Vehicle.SetTireFlat(index, true)`](/docs/scripting-reference/classes/vehicle#function-settireflat).
...
We added a new section to the docs listing all Standard Lua Libraries [string](/docs/scripting-reference/standard-libraries/string), [math](/docs/scripting-reference/standard-libraries/math) and [table](/docs/scripting-reference/standard-libraries/table), documenting it's methods and examples! To help newcomers learning the basics of Lua!
...
Also we are expanding some native class such as <BasicType.String /> by adding custom helper methods to it, like [`StartsWith()`](/docs/scripting-reference/standard-libraries/string#function-startswith), [`Trim()`](/docs/scripting-reference/standard-libraries/string#function-trim) and [`EndsWith()`](/docs/scripting-reference/standard-libraries/string#function-endswith), which can be called on the strings natively like:
...
Our <Classes.Canvas /> Class got several improvements allowing it to be positioned on screen with a new [`screen_position`](/docs/scripting-reference/classes/canvas#constructor-default-constructor). constructor parameter, and new methods [`Resize()`](/docs/scripting-reference/classes/canvas#function-resize), [`SetScreenPosition()`](/docs/scripting-reference/classes/canvas#function-setscreenposition) and [`SetAutoResize()`](/docs/scripting-reference/classes/canvas#function-setautoresize).
