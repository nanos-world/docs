...
### Joining the Playtest {/* #joining-the-playtest */}
...
## Scripting Files Encryption {/* #scripting-files-encryption */}
...
## Trigger Improvements {/* #trigger-improvements */}
...
### Server Thread Contention {/* #server-thread-contention */}
...
### Parallel Lua Files Load {/* #parallel-lua-files-load */}
...
### Network Authority Improvements {/* #network-authority-improvements */}
...
### Adventure Characters {/* #adventure-characters */}
...
### Bossy Enemy Anims {/* #bossy-enemy-anims */}
...
## New Scripting API Methods {/* #new-scripting-api-methods */}

We've implemented a bunch of new methods this month, to name a few:

### Widget Slots {/* #widget-slots */}

Widgets got new methods to control their layout in slots:

- <MethodReference type="Class" class_name="Widget" method_name="SetSlotAlignment" show_class_name />
- <MethodReference type="Class" class_name="Widget" method_name="SetSlotPadding" show_class_name />
- <MethodReference type="Class" class_name="Widget" method_name="SetSlotSize" show_class_name />

We also renamed the old <MethodReference type="Class" class_name="Widget" method_name="SetSlotCanvasLayout" show_class_name /> to keep naming consistency.
...
- <MethodReference type="StaticClass" class_name="PostProcess" method_name="SetGlobalGain" show_class_name />
- <MethodReference type="StaticClass" class_name="PostProcess" method_name="SetGlobalGamma" show_class_name />
- <MethodReference type="StaticClass" class_name="PostProcess" method_name="SetGlobalContrast" show_class_name />
- <MethodReference type="StaticClass" class_name="PostProcess" method_name="SetGlobalOffset" show_class_name />

### Other new Methods {/* #other-new-methods */}

- <MethodReference type="StaticClass" class_name="Server" method_name="GetEntityByID" show_class_name /> / <MethodReference type="StaticClass" class_name="Client" method_name="GetEntityByID" show_class_name />
- <MethodReference type="Class" class_name="Pawn" method_name="SetControlRotation" show_class_name />
- <MethodReference type="Class" class_name="Character" method_name="SetCanUsePickables" show_class_name />
- <MethodReference type="Class" class_name="Pickable" method_name="SetCanUse" show_class_name />
- <MethodReference type="Class" class_name="Character" method_name="SetPhysicsAsset" show_class_name /> / <MethodReference type="Class" class_name="CharacterSimple" method_name="SetPhysicsAsset" show_class_name />


## VOIP Improvements {/* #voip-improvements */}
...
## Testing Map Weather {/* #testing-map-weather */}
