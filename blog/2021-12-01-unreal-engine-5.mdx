...
## New Class: [Decal](/docs/scripting-reference/classes/decal) {/* #new-class-decal */}
...
## New Class: [Billboard](/docs/scripting-reference/classes/billboard) {/* #new-class-billboard */}
...
## New Class: [Melee](/docs/scripting-reference/classes/melee) {/* #new-class-melee */}
...
### Real Hot Reload {/* #real-hot-reload */}
...
## New View Mode: TopDown {/* #new-view-mode-topdown */}
...
## New Camera Methods {/* #new-camera-methods */}
...
## [TextRender](/docs/scripting-reference/classes/text-render) on Server Side {/* #textrender-on-server-side */}
