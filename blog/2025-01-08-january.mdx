...
## Latest Blog at Main Menu {/* #latest-blog-at-main-menu */}
...
## Disconnected Popup {/* #disconnected-popup */}
...
## Cache Files Location {/* #cache-files-location */}
...
Once we push the update, you will be able to read all changes in our [Changelog](https://docs.nanos-world.com/changelog).
