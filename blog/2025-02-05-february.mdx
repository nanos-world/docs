...
## New Profiling Tools {/* #new-profiling-tools */}
...
### Network Invokes {/* #network-invokes */}
...
## Network Interp Stutters {/* #network-interp-stutters */}
...
## Cached Vault API {/* #cached-vault-api */}
...
### API References Pop-up {/* #api-references-pop-up */}
...
- **Method Reference** example: <MethodReference type="Class" class_name="Actor" method_name="SetLocation" show_class_name />.
- **Event Reference** example: <EventReference type="Class" class_name="Entity" event="Destroy" />.


## New Assets Thumbnails {/* #new-assets-thumbnails */}
