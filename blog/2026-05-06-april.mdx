...
## Tracy Profiler Integration {/* #tracy-profiler-integration */}
...
## Loading Screen Improvements {/* #loading-screen-improvements */}
...
#### Server.SetValue {/* #serversetvalue */}

Now, <MethodReference type="StaticClass" class_name="Server" method_name="SetValue" show_class_name /> synced values are automatically **cached** and **compressed** before being sent to joining clients.
...
#### Other Internal Caches {/* #other-internal-caches */}
...
### API Methods Calls {/* #api-methods-calls */}
...
### Defer Entity Spawn System {/* #defer-entity-spawn-system */}

We implemented a new **Defer Spawn** system for entities, allowing you to create entities without immediately spawning them on clients until you explicitly call <MethodReference type="Class" class_name="Entity" method_name="FinishSpawn" show_class_name />.
...
#### Deprecated VehicleWheeled `auto_create_physics` parameter {/* #deprecated-vehiclewheeled-auto_create_physics-parameter */}
...
### New Methods & Events {/* #new-methods--events */}

All new methods and events related to this month's features and improvements are listed below.

#### New Methods {/* #new-methods */}

- <MethodReference type="StaticClass" class_name="Client" method_name="GetLanguage" show_class_name />
- <MethodReference type="Class" class_name="Entity" method_name="FinishSpawn" show_class_name />


#### New Events {/* #new-events */}

- <EventReference type="StaticClass" class_name="Client" event="LanguageChange" show_class_name />
- <EventReference type="StaticClass" class_name="Client" event="ValueChange" show_class_name />
- <EventReference type="StaticClass" class_name="Server" event="ValueChange" show_class_name />


### Improved APIs {/* #improved-apis */}

- **VOIP** (e.g. <MethodReference type="Class" class_name="Player" method_name="SetVOIPGlobalChannelSetting" show_class_name />) now support up to 63 channels instead of 31.
...
### New Distant Fix-up System {/* #new-distant-fix-up-system */}
...
## New Water Buoyancy Config {/* #new-water-buoyancy-config */}
...
## C:/Users/ Path Encoding Fix {/* #cusers-path-encoding-fix */}
