...
We added a new method to WebUI which although seems simple, it expands a lot the possibilities and modularity with UIs. Now it is possible to change the WebUI Canvas layout through [WebUI:SetLayout](/docs/next/scripting-reference/classes/web-ui#function-setlayout).
...
We added a new *experimental* method to WebUI: [WebUI:ExecuteJavaScript](/docs/next/scripting-reference/classes/web-ui#function-executejavascript). This allows executing arbitrary JavaScript code in your WebUI.
