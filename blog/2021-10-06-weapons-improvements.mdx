...
## New Weapon Animations {/* #new-weapon-animations */}
...
## New effects for Bullet Shells {/* #new-effects-for-bullet-shells */}
...
## SFX when Picking Up objects {/* #sfx-when-picking-up-objects */}
