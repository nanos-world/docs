...
## SceneCapture Encode {/* #scenecapture-encode */}

We added a new method to [SceneCapture](/docs/next/scripting-reference/classes/scenecapture): `EncodeToBase64()`!
...
## Player Avatar on Chat {/* #player-avatar-on-chat */}
...
## New Native Server Commands {/* #new-native-server-commands */}
...
## CharacterSimple Damageable {/* #charactersimple-damageable */}
...
## New Custom Settings Type: Select {/* #new-custom-settings-type-select */}
...
## Fatal Crashes Report {/* #fatal-crashes-report */}
...
## Blueprint Material as Arguments {/* #blueprint-material-as-arguments */}
...
### Ownership Manage {/* #ownership-manage */}
...
## Main Menu Notifications {/* #main-menu-notifications */}
...
## Assets.toml Files Validator {/* #assetstoml-files-validator */}
...
## New Trace Methods {/* #new-trace-methods */}
...
## New Sky Methods {/* #new-sky-methods */}
...
## Is Steam Launched {/* #is-steam-launched */}
