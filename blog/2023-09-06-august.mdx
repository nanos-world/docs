...
## Async Operations Improvs {/* #async-operations-improvs */}
...
## Package.Require Caching {/* #packagerequire-caching */}
...
## New Modules Behavior {/* #new-modules-behavior */}
...
## Scripting Safety {/* #scripting-safety */}
...
### Unsafe Libraries {/* #unsafe-libraries */}
...
## Recursive Scripting Tables {/* #recursive-scripting-tables */}
...
## New Methods and Params {/* #new-methods-and-params */}
...
- New method [CharacterSimple.CallAnimationBlueprintEvent()](/docs/next/scripting-reference/classes/charactersimple#function-callanimationblueprintevent) to call an event on the Animation Blueprint instance.
