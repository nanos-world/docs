...
The official Alpha 1.0.0 update will come with lots of scripting news!
...
With this new stage we decided to start fresh and restart our Tester subscriptions. Please check out [Sign Up for Alpha Testing](signing-up-alpha.mdx) for more information on how to become a Tester.
...
We've also created a new [Roadmap](roadmap.mdx) page with all our plans and redirecting to our official Roadmap boards!
