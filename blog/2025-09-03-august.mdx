...
## Reworked Website {/* #reworked-website */}
...
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPGlobalVolume" show_class_name />
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPLocalVolume" show_class_name />
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPLocalSetting" show_class_name />
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPGlobalChannelSetting" show_class_name />
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPGlobalAllChannelsSetting" show_class_name />
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPMuted" show_class_name />
...
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPGlobalHighPassFilter" show_class_name />
- <MethodReference type="Class" class_name="Player" method_name="SetVOIPGlobalLowPassFilter" show_class_name />
...
## Auto Detect Best Settings {/* #auto-detect-best-settings */}
...
## Server Favorite System {/* #server-favorite-system */}
...
## Pre-Compiled Shaders {/* #pre-compiled-shaders */}
...
- <MethodReference type="Class" class_name="CharacterSimple" method_name="BindAnimationBlueprintEventDispatcher" show_class_name />
- <MethodReference type="Class" class_name="CharacterSimple" method_name="UnbindAnimationBlueprintEventDispatcher" show_class_name />


## Console and Profiling {/* #console-and-profiling */}

![](/img/blog/2025-august/console-log.webp)

<MediaLegend>New Console Log types</MediaLegend>

We added a new scripting method to log in Debug mode: <MethodReference type="StaticClass" class_name="Console" method_name="Debug" show_class_name />, which means it will only be displayed if the server or client was configured with the log level as Debug or Verbose. It will be displayed as `S_DEBUG` category in the console.
...
## WebUI: Proper Drag'n Drop {/* #webui-proper-dragn-drop */}
...
## Attachable Improvements {/* #attachable-improvements */}
...
### Keybinding Clear Key {/* #keybinding-clear-key */}
...
## Ultra Dynamic Sky v9.0B {/* #ultra-dynamic-sky-v90b */}
...
## About Unreal Engine 5.6 {/* #about-unreal-engine-56 */}
