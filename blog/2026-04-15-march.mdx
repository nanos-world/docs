...
## Zenkai Hits 500+ Players! {/* #zenkai-hits-500-players */}
...
## New default-characters Package {/* #new-default-characters-package */}
...
## Server Performance Overhaul {/* #server-performance-overhaul */}
...
### Snapshot Sync Batching {/* #snapshot-sync-batching */}
...
### Bad Connections {/* #bad-connections */}
...
### Steam Maintenance {/* #steam-maintenance */}
...
### Lower Packet Footprint {/* #lower-packet-footprint */}
...
- <MethodReference type="StaticClass" class_name="Server" method_name="SetDefaultPlayerDimension" show_class_name />
- <MethodReference type="StaticClass" class_name="Server" method_name="SetDefaultEntityDimension" show_class_name />
- <MethodReference type="StaticClass" class_name="Server" method_name="AddMapSpawnPoint" show_class_name />
- <MethodReference type="StaticClass" class_name="Server" method_name="GetConnectionCount" show_class_name />
- <MethodReference type="StaticClass" class_name="Client" method_name="OpenEscapeMenu" show_class_name />
- <MethodReference type="Class" class_name="WebUI" method_name="IsReady" show_class_name />
- <MethodReference type="Class" class_name="Decal" method_name="SetSize" show_class_name />
- <MethodReference type="Class" class_name="Decal" method_name="SetFadeIn" show_class_name />
- <MethodReference type="Class" class_name="Decal" method_name="SetFadeOut" show_class_name />
- <MethodReference type="StaticClass" class_name="Events" method_name="CallRemotePlayers" show_class_name />


### Improved Methods {/* #improved-methods */}

- <MethodReference type="Class" class_name="VehicleWheeled" method_name="SetSteeringSetup" show_class_name /> - New `steering_curve` parameter
- <MethodReference type="Class" class_name="VehicleWheeled" method_name="SetTransmissionSetup" show_class_name /> - New `forward_gear_ratios`/`reverse_gear_ratios` parameters
- <MethodReference type="StaticClass" class_name="Sky" method_name="SetTimeOfDay" show_class_name /> - New `transition_time` parameter
- <MethodReference type="Class" class_name="Actor" method_name="IsNetworkDistributed" show_class_name /> - Now returns if the actor can *ever* distribute authority
- <MethodReference type="Class" class_name="Entity" method_name="GetCount" show_class_name /> - Now returns entities from all child classes
...
## Vehicles Handling Fixed {/* #vehicles-handling-fixed */}
...
## Thread Pool System {/* #thread-pool-system */}

We've implemented a new **Thread Pool System** for handling all the asynchronous operations:

- **HTTP Requests** - <MethodReference type="StaticClass" class_name="HTTP" method_name="RequestAsync" show_class_name />
- **Database Operations** - <MethodReference type="Class" class_name="Database" method_name="SelectAsync" show_class_name /> <MethodReference type="Class" class_name="Database" method_name="ExecuteAsync" show_class_name />
- **File Operations** - <MethodReference type="Class" class_name="File" method_name="ReadAsync" show_class_name />
...
## Authentication Queue System {/* #authentication-queue-system */}
...
## New Ray Tracing Settings {/* #new-ray-tracing-settings */}
...
## Loading Screen Enhancements {/* #loading-screen-enhancements */}
...
### Windows Taskbar Progress {/* #windows-taskbar-progress */}
...
## New Native Assets {/* #new-native-assets */}
...
## New Configs and Commands {/* #new-configs-and-commands */}
...
#### New Server Language Flag {/* #new-server-language-flag */}
...
#### `max_send_rate` Change {/* #max_send_rate-change */}
...
## Server List in Escape Menu {/* #server-list-in-escape-menu */}
