...
export const FunctionsDeclaration = ({ type, name }) => {
	const class_data = GetClassData(type, name);
	return (<>
		{ class_data.inheritance && class_data.inheritance.includes("Entity") ? <BaseEntityFunctions inherited_class_name={name} /> : "" }
...
export const StaticFunctionsDeclaration = ({ type, name }) => {
	const class_data = GetClassData(type, name);
	return (<>
		{ class_data.inheritance && class_data.inheritance.includes("Entity") ? <BaseEntityStaticFunctions inherited_class_name={name} /> : "" }
		{/* { class_data.inheritance && class_data.inheritance.includes("Actor") ? <BaseActorStaticFunctions inherited_class_name={name} /> : "" } */}
		{
			class_data.static_functions == null ? <i>This entity doesn't have own static functions.</i> :
			<>
				<StaticFunctionListDeclaration class_name={name} functions_list={class_data.static_functions} />
...
export const EventsDeclaration = ({ type, name }) => {
	const class_data = GetClassData(type, name);
	return (<>
		{ class_data.inheritance && class_data.inheritance.includes("Entity") ? <BaseEntityEvents inherited_class_name={name} /> : "" }
