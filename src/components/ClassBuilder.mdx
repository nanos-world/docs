...
export function GetReturnDescriptionList(return_list) {
	const return_list_plain = return_list.map((return_data) => <span dangerouslySetInnerHTML={{ __html: return_data.description }} />).reduce((prev, next) => [prev, ", ", next]);
...
export const EventListDeclaration = ({ type, name }) => {
...
export const BaseActorEvents = () => {
	...
	return (<>
		<details>
			...
			<ReferenceLink href="scripting-reference/classes/base-classes/actor">Base Actor</ReferenceLink>
			<EventListDeclaration type="Class" name="Actor" />
		</details>
	</>);
};
...
export const BasePickableEvents = () => (
	<details>
		...
		<ReferenceLink href="scripting-reference/classes/base-classes/pickable">Base Pickable</ReferenceLink>
		<EventListDeclaration type="Class" name="Pickable" />
	</details>
);
...
export const EventsDeclaration = ({ type, name }) => {
	...
	return (<>
		...
		{ class_data.inheritance && class_data.inheritance.includes("Pickable") ? <BasePickableEvents /> : "" }
		{
			...
			<>
				<EventListDeclaration type={type} name={name} />
