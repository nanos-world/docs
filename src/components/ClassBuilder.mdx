...
import { AuthorityType, NativeType, BasicType, Classes, Structs, Enums, AssetPath, LinkActiveVersion } from '@site/docs/components/_nanos.mdx';
...
export const GetLinkElement = ({ base_class, append_url, content }) => (
	<b>
		{ base_class ?
			<LinkActiveVersion to={`${`scripting-reference/classes/base-classes/${base_class.toLowerCase()}`}${append_url}`} className={"hover-link"}>
				<code>{ content }</code>
			</LinkActiveVersion>
		:
			<Link to={append_url} className={"hover-link"}>
				<code>{ content }</code>
			</Link>
		}
	</b>
...
export const StaticFunctionNameDeclaration = ({ class_name, function_data, base_class }) => (
	<Tippy interactive={true} maxWidth={1200} animation={"scale-subtle"} content={<StaticFunctionToolTip class_name={class_name} function_data={function_data} />}>
		<GetLinkElement base_class={base_class} append_url={`#static-function-${function_data.name.toLowerCase()}`} content={function_data.name} />
	</Tippy>
);
...
export const FunctionNameDeclaration = ({ class_name, function_data, base_class }) => (
	<Tippy interactive={true} maxWidth={1200} animation={"scale-subtle"} content={<FunctionToolTip class_name={class_name} function_data={function_data} />}>
		<GetLinkElement base_class={base_class} append_url={`#function-${function_data.name.toLowerCase()}`} content={function_data.name} />
	</Tippy>
);
...
export const EventNameDeclaration = ({ class_name, event_data, base_class }) => (
	<Tippy interactive={true} maxWidth={1200} animation={"scale-subtle"} content={<EventToolTip class_name={class_name} event_data={event_data} />}>
		<GetLinkElement base_class={base_class} append_url={`#event-${event_data.name.toLowerCase()}`} content={event_data.name} />
	</Tippy>
);
