...
## Assets Pack Configuration {/* #assets-pack-configuration */}
...
| **`unreal.unreal_folders`** | List of all folders exported by your Unreal Project to be mounted in game. This is important so the Assets can keep the relative references correctly |
| **`unreal.unreal_version`** | Version at which this Asset Pack was created |
| **`unreal.is_plugin_content`** | If this Asset Pack uses Plugin Content |
...
### Asset Meta Data {/* #asset-meta-data */}
...
## Referencing Assets in Scripting {/* #referencing-assets-in-scripting */}
...
## Creating your own Assets {/* #creating-your-own-assets */}
...
## Default Asset Pack {/* #default-asset-pack */}
