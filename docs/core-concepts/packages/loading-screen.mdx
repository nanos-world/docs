...
## Creating a Loading Screen {/* #creating-a-loading-screen */}

For that, you will need to create a new Package of type [loading-screen](packages-guide.mdx#package-types), and add your HTML/CSS/JS files into the Package's root folder. Your primary HTML file should be called `index.html`. It will look like that:
...
### Getting Load/Download Progress {/* #getting-loaddownload-progress */}
...
#### Event `UpdateScreen` {/* #event-updatescreen */}
...
### Stop Menu Music {/* #stop-menu-music */}
...
## Configuring your server to use the Loading Screen {/* #configuring-your-server-to-use-the-loading-screen */}
