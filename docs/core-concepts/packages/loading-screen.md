...
For that, you will need to create a new Package of type [loading-screen](packages-guide.md#package-types), and add your HTML/CSS/JS files into the Package's root folder. Your primary HTML file should be called `index.html`. It will look like that:
