...
## Creating your C Module binaries {/* #creating-your-c-module-binaries */}

To create your own module, first make sure you have **Visual Studio** installed with **Desktop development with C++** (and **CMake**) or any other C compiler on Linux.
...
### Compiling your C Module {/* #compiling-your-c-module */}
...
## Creating a C Module Package {/* #creating-a-c-module-package */}
...
## Loading and Using your C Module {/* #loading-and-using-your-c-module */}
