...
| **`packages`** | [script](/core-concepts/packages/packages-guide.md#script) packages to load |
| **`map`** | [map](/core-concepts/packages/packages-guide.md#map) package to load |
...
To configure a map, please refer to [Packages Guide](/core-concepts/packages/packages-guide.md#map) to create a Map Package pointing to the correct Asset.
