...
If you input a NPC to <MethodReference type="Class" class_name="Entity" method_name="IsValid" /> somewhere and there is no Player connected, he will only start walking once a Player joins the server.
