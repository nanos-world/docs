...
Timer.SetInterval(function()
    ...
    local trace_result = Client.TraceLineSingle(start_location, end_location, CollisionChannel.WorldStatic | CollisionChannel.PhysicsBody, TraceMode.ReturnEntity | TraceMode.DrawDebug)
