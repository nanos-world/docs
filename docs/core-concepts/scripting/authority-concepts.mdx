...
* If the Character is **grabbing** a [Prop](/docs/scripting-reference/classes/prop)
* If the Character is **handling** a [Pickable](/docs/scripting-reference/classes/base-classes/pickable)
