...
This file is only created if you call <MethodReference type="StaticClass" class_name="Package" method="SetPersistentData" is_static show_class_name />.


## Storing and Retrieving data

All **PersistentData** files are loaded automatically when the Package loads and stored in memory. You can easily access the whole file with <MethodReference type="StaticClass" class_name="Package" method="GetPersistentData" is_static show_class_name />.
