...
keywords: [docs, contributing, docusaurus]
...
To preview your changes before opening a Pull Request, clone the [docs repository](https://github.com/nanos-world/docs) **with its submodules** (the API is a submodule) and run it with [Node.js](https://nodejs.org/) and [Yarn](https://yarnpkg.com/):
...
### Translated Pages {/* #translated-pages */}
