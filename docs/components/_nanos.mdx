...
export const Classes = {
	Entity: () => BaseClass("Base Entity", "🧩", "base-classes/entity"),
...
export const AssetPath = {
	...
	HTML: () => TippyLink("HTML", "HTML Path", "Web URL or HTML File Path:<br/><code>file://UI/index.html</code>.", "scripting-reference/classes/webui#html-path-searchers"),
};