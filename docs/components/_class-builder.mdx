...
export const AuthorityLabels = {
	client: <>This is a 🟧 <a href="/docs/core-concepts/scripting/authority-concepts">Client</a> only class.</>,
	server: <>This is a 🟦 <a href="/docs/core-concepts/scripting/authority-concepts">Server</a> only class.</>,
	both: <>This class is accessible on both 🟧 <a href="/docs/core-concepts/scripting/authority-concepts">Client</a> and 🟦 <a href="/docs/core-concepts/scripting/authority-concepts">Server</a> (if you spawn it on client, it won't be synchronized with other players).</>,
}
...
export const AuthorityAdmonition = ({ authority }) => (
	<Admonition type="info" icon="💂" title="Authority">{ AuthorityLabels[authority] }</Admonition>
);
...
export const FunctionDeclaration = ({ function_data, is_static, class_name }) => (
	<>
		...
		<blockquote>
			{ function_data.description }{ function_data.return ? <><br/><br/>Returns { GetElementByType(function_data.return.type) } ({ function_data.return.description })</> : "" }
		</blockquote>
