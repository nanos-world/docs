...
|  | [**`Unban`**](server#unban) | Unbans a Player |
| <BasicType.Function /> | [**`Subscribe`**](server#subscribe) | Subscribes for an Event |
...
| <BasicType.Table /> | [**`GetMaps`**](server#getmaps) | Returns a list of all Maps installed on the server |
...
| <BasicType.String /> | [**`GetIP`**](server#getip) | Returns the server Public IP |
| <BasicType.Number /> | [**`GetPort`**](server#getport) | Returns the server Port |
| <BasicType.Number /> | [**`GetQueryPort`**](server#getqueryport) | Returns the server QueryPort |
| <BasicType.Number /> | [**`GetMaxPlayers`**](server#getmaxplayers) | Returns the Max Players configured |
| <BasicType.Number /> | [**`GetDescription`**](server#getdescription) | Returns the Server Description |
| <BasicType.Number /> | [**`GetTickRate`**](server#gettickrate) | Returns the Configured Tick Rate |
| <BasicType.Number /> | [**`IsAnnounced`**](server#isannounced) | Returns if the Server is announced in the Master List |
...
```lua
Server.Unban(player_account_id)
```

| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| <BasicType.String /> | **`player_account_id`** |  | Player nanos account ID |
...
>
> Returns a <BasicType.Table /> in the format `{{ key, author, compatible_game_modes }, ...}`
...
> 
> Return **false** to say it was handled and do not display a console message
...
| <BasicType.String /> | **`player_steam_ID`** |  |
