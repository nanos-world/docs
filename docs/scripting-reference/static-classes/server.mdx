...
| <BasicType.String /> | [**`GetBuildID`**](server#getbuildid) | Returns the server build id |
| <BasicType.String /> | [**`GetBranch`**](server#getbranch) | Returns the server branch name |
...
> Gets the server branch name (i.e. 'bleeding-edge')
>
> Returns <BasicType.String />
