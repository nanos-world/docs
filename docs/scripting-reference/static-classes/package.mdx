...
| <BasicType.Function /> | [**`Subscribe`**](package#subscribe) | Subscribes for an Event |
...
| <BasicType.String /> | [**`GetVersion`**](package#getversion) | Gets the package version |
...
> Called when this package unloads
