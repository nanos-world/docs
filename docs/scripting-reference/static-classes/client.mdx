...
|  | [**`SetMousePosition`**](client#setmouseposition) | Sets the mouse position |
|  | [**`SetHighlightColor`**](client#sethighlightcolor) | Changes the Highlight Color for highlighted actors at a specific Index |
|  | [**`SetOutlineColor`**](client#setoutlinecolor) | Changes the Outline Color for outlined actors at a specific Index |
...
| <BasicType.Boolean /> | [**`InputKey`**](client#inputkey) | Forces an Input Key event on Local Player |
...
| [**`ChatEntry`**](client#chatentry) | Called when a Chat Entry is received, this is also triggered when `SendChatMessage` is called |
...
| [**`MouseMoveX`**](client#mousemovex) | Called when the mouse moves in the X axis |
| [**`MouseMoveY`**](client#mousemovey) | Called when the mouse moves in the Y axis |
| [**`MouseScroll`**](client#mousescroll) | Mouse scroll event |
| [**`OpenChat`**](client#openchat) | When player opens the Chat |
| [**`CloseChat`**](client#closechat) | When player closes the Chat |
| [**`OpenConsole`**](client#openconsole) | When player closes the Console |
| [**`CloseConsole`**](client#closeconsole) | When player closes the Console |
| [**`Tick`**](client#tick) | Called Every Frame. Do not abuse |
| [**`ViewportResized`**](client#viewportresized) | Called when the screen is resized |
| [**`SpawnLocalPlayer`**](client#spawnlocalplayer) | Called when the local player spawns |
| [**`WindowFocusChanged`**](client#windowfocuschanged) | Called when the game is focused/unfocused |
...
| <BasicType.String /> | **`reset_time`** | `false` | Whether or not to reset current activity elapsed time |
...
| <BasicType.Number /> | **`index`** | `0` |
| <Enums>HighlightMode</Enums> | **`mode`** | `HighlightMode.Always` |
...
| :--- | :--- | :--- | :--- |
| <BasicType.String /> | **`key_name`** |  | Key Name to input |
| <Enums>InputEvent</Enums> | **`input_event`** | Which Event to input (Released/Pressed) |
| <BasicType.Number /> | **`amount_depressed`** | `1` | The amount pressed |
...
| Type | Parameter | Description |
| :--- | :--- | :--- |
| <BasicType.Number /> | **`delta`** |  |
| <BasicType.Number /> | **`delta_time`** |  |
| <BasicType.Number /> | **`num_samples`** |  |
...
```lua
Client.Subscribe("MouseScroll", function(mouse_x, mouse_y, delta)
...
| Type | Parameter | Description |
| :--- | :--- | :--- |
| <Classes.Player /> | **`local_player`** | The local Player |
...
| Type | Parameter | Description |
| :--- | :--- | :--- |
| <BasicType.Boolean /> | **`is_focused`** | If it's focused |
