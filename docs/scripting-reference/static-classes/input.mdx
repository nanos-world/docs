...
This is a Static Class named `Input`. You can access it’s methods directly with `.`. It is not possible to initialize or create new instances.
...
This Class is **experiemental**, so you can try it out and provide feedback before it's full release!
