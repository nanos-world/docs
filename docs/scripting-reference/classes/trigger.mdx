...
| [TriggerType](/docs/scripting-reference/glossary/enums#triggertype) | **`trigger_type`** | `TriggerType.Sphere` | Currently supports **Sphere** of **Box** |
...
| [Actor](/docs/scripting-reference/classes/base-classes/actor) | `entity` | Any Actor which overlaps |
...
| :--- | :--- | :--- |
| [Trigger](trigger) | `self` | The Trigger entity |
| [Actor](/docs/scripting-reference/classes/base-classes/actor) | `entity` | Any Actor which left the Trigger |
