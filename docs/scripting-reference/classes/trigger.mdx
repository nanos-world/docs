...
| [Actor](/docs/scripting-reference/base-classes/actor) | `entity` | Any Actor which overlaps |
...
| :--- | :--- | :--- |
| [Trigger](trigger) | `self` | The Trigger entity |
| [Actor](/docs/scripting-reference/base-classes/actor) | `entity` | Any Actor which left the Trigger |
