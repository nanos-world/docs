...
| <StructType.Vector /> | **`scale`** | `Vector(1, 1, 1)` |
| <StructType.Color /> | **`color`** | `Color(1, 1, 1, 1)` |
| [FontType](/docs/scripting-reference/glossary/enums#fonttype) | **`font_type`** | `FontType.Roboto` |
| [TextRenderAlignCamera](/docs/scripting-reference/glossary/enums#textrenderaligncamera) | **`align_camera`** | `TextRenderAlignCamera.Unaligned` |
...
| [TextRenderBevelType](/docs/scripting-reference/glossary/enums#textrenderbeveltype) | **`bevel_type`** | `TextRenderBevelType.Convex` |  |
...
| [TextRenderHorizontalAlignment](/docs/scripting-reference/glossary/enums#textrenderhorizontalalignment) | **`horizontal_alignment`** | `TextRenderHorizontalAlignment.Center` |  |
| [TextRenderVerticalAlignment](/docs/scripting-reference/glossary/enums#textrenderverticalalignment) | **`vertical_alignment`** | `TextRenderVerticalAlignment.Center` |  |
