...
| <BasicType.Enum type="FontType" /> | **`font_type`** | `FontType.Roboto` |
| <BasicType.Enum type="TextRenderAlignCamera" /> | **`align_camera`** | `TextRenderAlignCamera.Unaligned` |
...
| <BasicType.Enum type="TextRenderBevelType" /> | **`bevel_type`** | `TextRenderBevelType.Convex` |  |
...
| <BasicType.Enum type="TextRenderHorizontalAlignment" /> | **`horizontal_alignment`** | `TextRenderHorizontalAlignment.Center` |  |
| <BasicType.Enum type="TextRenderVerticalAlignment" /> | **`vertical_alignment`** | `TextRenderVerticalAlignment.Center` |  |
