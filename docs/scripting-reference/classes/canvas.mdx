...
You can use the output Texture from a Canvas with [:SetMaterialFromCanvas()](/scripting-reference/classes/base-classes/paintable.mdx#function-setmaterialfromcanvas) method!
