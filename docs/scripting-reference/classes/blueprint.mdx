...
| <Classes.Light /> | **`PointLight`**, **`SpotLight`** or **`RectLight`** | ✅ | ✅ |
| <Classes.Decal /> | **`DecalActor`** | ✅ | ✅ |
| <Classes.TextRender /> | **`TextRenderActor`** | ✅ | ✅ |
| <Classes.Text3D /> | **`Text3DActor`** | ✅ | ✅ |
...
| [**`steam-avatar://`**](/scripting-reference/glossary/basic-types.mdx#steam-avatar) | **`MaterialInstanceDynamic`** | ✅ | ❌ |
| <BasicType.Table /> | [**`CurveFloat`**](#ucurvefloat) | ✅ | ❌ |
