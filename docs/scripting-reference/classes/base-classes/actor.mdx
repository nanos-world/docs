...
|  | **Name** | **Description** |
| :--- | :--- | :--- |
|  | [**`Destroy`**](actor#destroy) | Triggered when an Entity is Destroyed |
|  | [**`Spawn`**](actor#spawn) | Triggered when an Entity is Spawned/Created |
|  | [**`ValueChange`**](actor#valuechange) | Triggered when an Entity has it’s value changed |
...
| :--- | :--- | :--- | :--- |
| <StructType.Vector /> | **`force`** |  | Force to apply |
...
| [AttachmentRule](/docs/scripting-reference/glossary/enums#attachmentrule) | **`attachment_rule`** | `SnapToTarget` | How to attach |
| <BasicType.String /> | **`bone_name`** | `""` | Which bone to attach |
| <BasicType.Boolean /> | **`autodestroy_when_detached`** | `false` | Whether to auto destroy when detached |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| [CollisionType](/docs/scripting-reference/glossary/enums#collisiontype) | **`collision_type`** |  | Collision Type |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| <StructType.Vector /> | **`location`** |  | New Location |
...
>
> Please refer to [Network Authority](/docs/core-concepts/scripting/authority-concepts#network-authority) for more information
...
| <BasicType.Number /> | **`time_ms`** | `0` | New player which will assume the Network Authority of this entity |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| <StructType.Rotator /> | **`rotation`** |  | New Rotation |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| <StructType.Vector /> | **`scale`** |  | New Scale |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| <StructType.Vector /> | **`location`** |  | Location to Translate to |
| <BasicType.Number /> | **`speed`** |  |  |
| <BasicType.Number /> | **`sweep`** |  | Whether |
| <BasicType.Boolean /> | **`teleport`** |  |  |
...
| Type | Parameter | Default Value | Description |
| :--- | :--- | :--- | :--- |
| <StructType.Rotator /> | **`rotation`** |  | Rotation to Translate to |
| <BasicType.Number /> | **`speed`** |  |  |
| <BasicType.Boolean /> | **`teleport`** |  | Whether to affect the current Velocity |
