...
:::info
⏬ **Inheritance:** This class inherits from [Actor](/docs/scripting-reference/base-classes/actor) and [Paintable](/docs/scripting-reference/base-classes/paintable). Please check their pages for inherited **Methods** and **Events**.
:::
...
>
> returns [Player ](player.md)or [nil ](/docs/scripting-reference/glossary/basic-types#nil)if Seat is invalid or empty
