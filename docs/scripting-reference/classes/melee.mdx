---
title: 🔪 Melee
description: A Melee represents an Entity which can be Pickable by a Character, doesn't have any special action unless holding it with hands with pre-defined handling modes.
sidebar_position: 0
tags: [class]
---
