...
|  | [Character](/docs/scripting-reference/classes/character) | [**`GetHandler`**](prop#gethandler) | Gets the Character \(if existing\) which is holding this |
...
>
> Returns [Character](/docs/scripting-reference/classes/character)
...
| [Character](/docs/scripting-reference/classes/character) | `character` | The new Grabber |
...
| [Character](/docs/scripting-reference/classes/character) | `character` | The old Grabber |
