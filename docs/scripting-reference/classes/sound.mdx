...
| :--- | :--- | :--- | :--- |
| <StructType.Vector /> | **`location`** | `Vector(0, 0, 0)` | 3D only |
...
| [SoundType](/docs/scripting-reference/glossary/enums#soundtype) | **`sound_type`** | `SoundType.SFX` | Used to apply user’s volume settings |
...
| [AttenuationFunction](/docs/scripting-reference/glossary/enums#attenuationfunction) | **`attenuation_function`** | `Linear` | 3D only |
...
| <BasicType.Number /> | **`fade_volume_level`** |  |
| <BasicType.Number /> | **`start_time`** |  |
