...
| <BasicType.Enum type="SoundType" /> | **`sound_type`** | `SoundType.SFX` | Used to apply user’s volume settings |
...
| <BasicType.Enum type="AttenuationFunction" /> | **`attenuation_function`** | `Linear` | 3D only |
