...
This is a minimal example to learn how Lua and a WebUI talk to each other. For a complete, production HUD, check the one in our [Sandbox Official Repository](https://github.com/nanos-world/nanos-world-sandbox).
...
In this UI we will be using [jQuery](https://jquery.com/), please download [jQuery 3.7.1](https://code.jquery.com/jquery-3.7.1.min.js) and place it inside `UI/` folder.
...
## Adding Events and Callbacks to communicate with your Package {/* #adding-events-and-callbacks-to-communicate-with-your-package */}
