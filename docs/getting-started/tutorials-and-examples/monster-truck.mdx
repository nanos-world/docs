...
-- Spawns a Pickup
local vehicle = VehicleWheeled(Vector(0,0,100), Rotator(), "nanos-world::SK_Pickup", CollisionType.Normal, true, false, "nanos-world::A_Vehicle_Engine_10",
    "nanos-world::A_Vehicle_Horn_Toyota",
    "nanos-world::A_Vehicle_Brake",
    "nanos-world::A_Car_Engine_Start",
    "nanos-world::A_Vehicle_Door",
    true,
    "",
    true)
