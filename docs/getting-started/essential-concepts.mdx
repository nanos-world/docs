...
You can output messages to the console using the <StaticClasses.Console /> Static Class, which provides different log levels such as <MethodReference type="StaticClass" class_name="Console" method="Log" is_static />, <MethodReference type="StaticClass" class_name="Console" method="Debug" is_static />, <MethodReference type="StaticClass" class_name="Console" method="Warn" is_static /> and <MethodReference type="StaticClass" class_name="Console" method="Error" is_static />:
...
For example, events are fired when a <Classes.Player /> spawns (<EventReference type="Class" class_name="Entity" event="Spawn" is_base />), a <Classes.Character /> enters a vehicle (<EventReference type="Class" class_name="Character" event="EnterVehicle" />) or takes damage (<EventReference type="Class" class_name="Damageable" event="TakeDamage" is_base />).
...
Our Timer API is similar to **JavaScript Timers**, you can use <MethodReference type="StaticClass" class_name="Timer" method="SetTimeout" is_static show_class_name /> to execute a function once after a delay, or <MethodReference type="StaticClass" class_name="Timer" method="SetInterval" is_static show_class_name /> to continuously execute a function repeatedly at a specified interval.
...
For example, we can get all spawned entities from a class with their static methods <MethodReference type="Class" class_name="Entity" method="GetAll" is_base is_method_static /> or <MethodReference type="Class" class_name="Entity" method="GetPairs" is_base is_method_static />:
...
Or we can get a reference to an existing <Classes.Prop /> with a specific Index with the method <MethodReference type="Class" class_name="Entity" method="GetByIndex" is_base is_method_static />:
...
Another way is retrieving an entity by it's globally unique ID with the methods <MethodReference type="StaticClass" class_name="Server" method="GetEntityByID" is_static show_class_name /> or <MethodReference type="StaticClass" class_name="Client" method="GetEntityByID" is_static show_class_name />:
...
You can retrieve the Player's possessing Character with the method <MethodReference type="Class" class_name="Player" method="GetControlledCharacter" show_class_name />.


#### Retrieving the Local Player on Client Side

On **Client** side, there are some special methods and events to retrieve the local Player: <MethodReference type="StaticClass" class_name="Client" method="GetLocalPlayer" is_static show_class_name /> and <EventReference type="StaticClass" class_name="Client" event="SpawnLocalPlayer" is_static show_class_name />:
