...
To create a new Package, lets use the handy [CLI](/docs/core-concepts/server-manual/command-line-interface) tool to speed up the process. Open a terminal in your server folder and run the following command:
