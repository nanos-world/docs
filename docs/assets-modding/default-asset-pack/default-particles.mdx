...
| :--- | :--- | :--- | :--- |
| **`Color`** | <Structs.Color /> | `Color.WHITE` | Color - multiply it to make it glow |
| **`SpawnCount`** | [Integer](/scripting-reference/classes/particle.mdx#setparameterint) | `25` | Amount of Particles to spawn |
...
| :--- | :--- | :--- | :--- |
| **`Color`** | <Structs.Color /> | `Color.WHITE` | Color - multiply it to make it glow |
| **`SpawnCount`** | [Integer](/scripting-reference/classes/particle.mdx#setparameterint) | `50` | Amount of Particles to spawn |
