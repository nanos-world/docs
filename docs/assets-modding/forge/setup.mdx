...
The plugin can be installed to any Unreal Engine project, but it is recommended to use it with the [nanos world ADK](/assets-modding/creating-assets/adk-assets-development-kit.mdx), as it already includes the nanos world packaging configuration.


### Downloading nanos world Forge {/* #downloading-nanos-world-forge */}
...
### Opening the Forge Window {/* #opening-the-forge-window */}
...
## Tools in nanos world Forge {/* #tools-in-nanos-world-forge */}

Here are the tools currently available in nanos world Forge:

- [Object2Lua](/docs/assets-modding/forge/tools/object2lua.mdx): Converts Unreal Engine blueprint assets into Lua tables.
- [Foliage2Lua](/docs/assets-modding/forge/tools/foliage2lua.mdx): Transforms foliage actors into Lua table representations.
- [Material Picker](/docs/assets-modding/forge/tools/material-picker.mdx): Quickly identify materials by clicking on them in the viewport.
- [Placeholders](/docs/assets-modding/forge/tools/placeholders.mdx): Place actors in your map and export them to Lua code.
- [Quick Instancer](/docs/assets-modding/forge/tools/quick-instancer.mdx): Converts Static Mesh actors into Instanced Static Mesh actors for better performance.
- [StaticMeshToFoliage](/docs/assets-modding/forge/tools/static-mesh-to-foliage.mdx): Converts static mesh actors into foliage types for landscape painting.
- [Thumbnail Generator](/docs/assets-modding/forge/tools/thumbnail-generator.mdx): Creates high-quality PNG thumbnails for assets, with bulk processing support.
