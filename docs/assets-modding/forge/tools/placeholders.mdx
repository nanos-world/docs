---
title: Placeholders
description: Forge tool to place actors in your map and export them to Lua code
tags: [assets, forge]
...
Unlike the placeholders in the [ADK](/assets-modding/creating-assets/adk-assets-development-kit.mdx), Forge placeholders are not limited to hardcoded classes. You can create your own placeholder actors with custom properties and export them to Lua code.

## Creating Placeholders {/* #creating-placeholders */}
...
### Placeholder Component Properties {/* #placeholder-component-properties */}
...
## Using the Placeholder Exporter {/* #using-the-placeholder-exporter */}
...
## Example Prop Placeholder {/* #example-prop-placeholder */}

For this example, we will create a custom placeholder that represents a <Classes.Prop /> entity.
...
### PlaceholderPlayerStart {/* #placeholderplayerstart */}
