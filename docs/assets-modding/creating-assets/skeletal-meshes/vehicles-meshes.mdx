...
Vehicles in nanos world implement Unreal's [Wheeled Vehicle](https://dev.epicgames.com/documentation/en-us/unreal-engine/vehicles-in-unreal-engine). The base Mesh of a vehicle is a **Skeletal Mesh**.


## Preparing a Skeletal Mesh {/* #preparing-a-skeletal-mesh */}
...
## Preparing the Physical Asset {/* #preparing-the-physical-asset */}
...
## Adding Dynamic Head & Tail Lights {/* #adding-dynamic-head--tail-lights */}
...
## Exporting the Vehicle {/* #exporting-the-vehicle */}
