...
Before proceeding, please make sure you read [Creating & Importing Assets](/assets-modding/creating-assets/importing-assets.mdx) Guide. You will need to use the ADK for this guide.
...
## Assigning nanos world Skeleton {/* #assigning-nanos-world-skeleton */}
